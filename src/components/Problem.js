                    ...
                    <div className="accordion-item">
                        ...
                        <div id={`collapse${parentId}a${eachItem.id}`} style={myStyle} className="accordion-collapse collapse" aria-labelledby={`heading${parentId}a${eachItem.id}`} data-bs-parent={`#accordionExample${parentId}a${eachItem.id}`}>
                            <div className="accordion-body">
                                {/* <h6>Count Digits</h6> */}
                                <p className={`text-${props.mode === 'light'?'dark':'light'}`}>For problem statement visit below Coding Question link and practice it. Don't worry if you are not able to solve it, check video solution -&gt; understand properly -&gt; try it (Bruteforce, Better, Optimal Approach)</p>
                                <ul style={bulletStyle}>
                                    <li><h6 className={`text-${props.mode === 'light'?'dark':'light'}`}>Learn: <a href={`${eachItem.vedioLec}`} target="_blank"><i className="fa-brands fa-youtube"></i> Concept </a></h6></li>
                                    ...
                                    <li>
                                        <h6 className={`text-${props.mode === 'light'?'dark':'light'}`}>Practice : <i className="fa-regular fa-keyboard"></i></h6>
